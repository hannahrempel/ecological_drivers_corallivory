...
```{r Fig. S2: Coral taxa selectivity by site and region, fig.height = 4.33, fig.width = 8.46}
#creating preliminary figure
...
plot(n_grazed_diversity_nbinom_residuals) #diagnostic plot also indicate no sig problems... both models fine
