...
```{r Fig. SX: parrotfish density by size range and species}
figsx_pf_size_dist <- pf_by_region_size_species_df %>% 
  ggplot()+
...
ggsave(plot=figsx_pf_size_dist, 
       filename=here("supplements/fig_sx_parrotfish_density_by_size_species.jpg"), 
